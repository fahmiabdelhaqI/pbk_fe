...
<nav class="navbar navbar-top navbar-expand navbar-dark bg-white">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!--  form menu -->
            <!-- <form class="navbar form-inline mr-sm-3">
                <div class="form-group mb-0">
                    <a class="h1 font-weight-bold">Profile Setting</a>
                </div>
            </form> -->
...
<!--                                <img alt="Image placeholder" src="../assets/img/theme/team-4.jpg">-->
                                <img alt="Image placeholder" src="http://alumni.polinema.ac.id/images/foto_alumni/2018/1441180053_emrWi.jpg">
                            </span>
                            <div class="media-body ml-2 d-none d-lg-block" style="color:black;">
                                <?php
                                    $sqlFetchUser = $conn->query("SELECT * FROM users WHERE id = ".$_SESSION['id_user']);
                                    $rowFetchUser = $sqlFetchUser->fetch_assoc();
                                    ?><span class="mb-0 text-sm  font-weight-bold"><?= $rowFetchUser['nama']?></span><?php
                                ?>
