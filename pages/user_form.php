...
<html lang="en">
    <head>
        ...
        <title>Form <?php if($method == 'create'){echo 'Add';}else{echo 'Edit';}?> Key User</title>
    </head>
    <body>
                            ...
                            <div class="col-lg-6 col-7">
                                ...
                                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                    <ol class="breadcrumb breadcrumb-links">
                                        ...
                                        <li class="breadcrumb-item"><a href="user_management.php">Key User List</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Key User Form</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <?php
                            ...
                            {
                                ?>
                                    <form action="../action/keyuser.php?crud=create" method="post" enctype="multipart/form-data" accept-charset="UTF-8" data-toggle="validator" role="form">
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-control-label">Member</label>
                                                <select id="select-member" name="member">
                                                    <option></option>
                                                    <?php
                                                        $sqlFetchMember = $conn->query("SELECT * FROM members");
                            ...
                            else
                            {
                                ...
                                $sqlFetchUser = $conn->query("SELECT * FROM users WHERE id = ".$idUsers);
                                $rowFetchUser = $sqlFetchUser->fetch_assoc();
                                ?>
                                    <form action="../action/keyuser.php?crud=edit&idUsers=<?= $idUsers;?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8" data-toggle="validator" role="form">
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-control-label">Member</label>
                                                <select id="select-member" name="member">
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                            ?>
                                                                <option <?php if($rowFetchUser['id_member'] == $rowFetchMember['id']){echo 'selected';}?> value="<?= $rowFetchMember['id']?>"><?= "(".$rowFetchMember['member_code'].") ".$rowFetchMember['member_name']?></option>
                                                            <?php
                                                        }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <center>
                                                    ...
                                                    <a href="user_management.php" class="btn btn-white" onclick="return confirm('Yakin membatalkan pengubahan ini?')">CANCEL</a>
                                                </center>
                                            </div>
                                        </div>
                                    </form>
